...
const HeroCarousel = () => {
  ...
  return (
    ...
    >
    {
        items.map( (item, i) => <Item key={i+1} page={page} setPage={setPage} item={item} /> )
    }
   </Carousel>
  )
}
...
function Item(props)
{
    ...
    return (
      <Paper 
        ...
        <Pagination style={{width:'fit-content'}} color='lightSec' count={items.length} page={props.page===0?1:props.page} onChange={handleChange} />
        </Box>
